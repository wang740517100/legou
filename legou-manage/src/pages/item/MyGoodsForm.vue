    ...
    <v-stepper-items>
      ...
      <v-stepper-content step="3">
        <v-flex class="xs10 mx-auto px-3">
            <v-card v-for="spec in specialSpec" :key="spec.group" class="my-2">
    ...
    export default {
        ...
        return {
          ...
          goods:{
            ...
            spuDetail:{
              ...
              afterService:'', //售后服务
              description: '', //商品描述
              genericSpec: '',// sku属性模板的字符串格式
              specialSpec:[],
            }
          },
          brandOptions:[], //品牌列表
          specialSpec:[],//公共规格参数模板
        ...
        oldGoods:{
          ...
          handler(val){
            ...
            if (val !== null && val.spuDetail !== null){
              ...
              this.isEdit = true;
              this.oldData = val.spuDetail.specialSpec;
      ...
      methods:{
        ...
        dataProces(temp){
          ...
          this.specialSpec = commonTemplate;
        },
        ...
        editDataProces(temp){
          ...
          temp.forEach(({params}) => {
            params.forEach(({k, v, options, global}) => {
              if(!global) {
                if (options === null) {
                  editSpecialTemplate.push({k, v})
                } else {
                  editSpecialTemplate.push({k, selected:options})
                }
              }
            })
          });
          ...
          this.specialSpec.forEach(({group,params}) => {
        ...
        submit(){
          ...
          //2.处理全部规格参数
          //目前specialSpec中只有公共属性的值，要把特有属性的值加上，一起存入数据库
          ...
          goodsParams.spuDetail.specialSpec = JSON.stringify(genericSpec);
