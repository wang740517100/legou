...
import cn.wangkf.client.BrandClient;
import cn.wangkf.client.CategoryClient;
import cn.wangkf.client.GoodsClient;
...
import cn.wangkf.common.utils.JsonUtils;
...
public class GoodsServiceImpl implements GoodsService {
    ...
    public Map<String, Object> loadModel(Long spuId) {
        ...
        String allSpecJson = spuDetail.getGenericSpec();
        ...
        //获取特有规格参数
        String specTJson = spuDetail.getSpecialSpec();
    ...
    public void createHtml(Long spuId) {
        ...
        //输出流
        File dest = new File("E:\\myproject\\upload", spuId + ".html");
        ...
        try(PrintWriter writer = new PrintWriter(dest, "UTF-8")){
            //生成HTML
            thymeleafEngine.process("item", context, writer);
